...
export const MODULE11_TASKS: Record<number, NodeTasks> = {
  ...
  2: {
    lesson: {
      ...
      prompt: "Knight uncovers rook — Nd6+ wins the queen!",
      hint: "Knight to d6 — checks AND opens the rook.",
    ...
    puzzle: {
      ...
      prompt: "Nf6+ — discovered check wins the queen!",
      hint: "Knight to f6 — rook attacks queen.",
    ...
    challenge: {
      ...
      prompt: "Nb4 — discovered attack on the queen!",
      hint: "Open the d-file with the knight.",
  ...
  10: {
    ...
    puzzle: {
      ...
      fen: "4k3/8/8/3q4/8/3N4/8/3R2K1 w - - 0 1",
      prompt: "Nb4 — rook attacks queen, treasure!",
      hint: "Knight clears the d-file.",
      goal: { kind: "move", from: "d3", to: "b4" },
      highlightFrom: "d3", highlightTo: "b4",
    },
    challenge: {
  ...
  11: {
    ...
    challenge: {
      ...
      fen: "4k3/8/4B3/8/8/8/8/4R2K w - - 0 1",
      prompt: "Bb3 — discovered rook check!",
      hint: "Bishop off the e-file.",
      goal: { kind: "move", from: "e6", to: "b3" },
      highlightFrom: "e6", highlightTo: "b3",
    },
  },
