...
export const MODULE14_TASKS: Record<number, NodeTasks> = {
  ...
  9: {
    ...
    challenge: {
      ...
      fen: "4k2q/8/8/8/8/8/8/4R2K w - - 0 1",
      prompt: "Re8+ — skewer wins the queen!",
      hint: "Rook to e8.",
      goal: { kind: "move", from: "e1", to: "e8" },
      highlightFrom: "e1", highlightTo: "e8",
    },
