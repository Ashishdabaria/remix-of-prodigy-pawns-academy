...
export const MODULE9_TASKS: Record<number, NodeTasks> = {
  ...
  10: {
    lesson: {
      ...
      prompt: "Endgame finish — Qg7 to g8 is mate? No — Qg7 takes g8? Try Qg7 to h7#",
      hint: "Queen g7 to h7 delivers mate next to the King.",
      goal: { kind: "mate-in-1" },
      highlightFrom: "g7",
    },
    puzzle: {
      ...
      prompt: "Mate in 1 — find the finishing move!",
      hint: "Queen to g7 or h7 mates with King support.",
      goal: { kind: "mate-in-1" },
      highlightFrom: "f7",
    },
    challenge: {
      ...
      prompt: "Land the mate — pick the winning move!",
      hint: "Queen to f8 or g7 finishes.",
      goal: { kind: "mate-in-1" },
      highlightFrom: "f7",
    },
  },
